        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex space-x-4">
                    <Link href="{{ route('login') }}" class="flex items-center text-sm font-medium text-gray-600 bg-white hover:text-gray-800 focus:outline-none transition duration-150 ease-in-out">Log in</Link>
                    
                    @if (Route::has('register'))
                    <Link href="{{ route('register') }}" class="flex items-center text-sm font-medium text-gray-600 bg-white hover:text-gray-800 focus:outline-none transition duration-150 ease-in-out">Register</Link>
                    @endif
                </div>
                @endauth
                @endif
